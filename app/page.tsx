...
export default function LandingPage(){
    ...
    return(
        ...
        <div className='fixed top-16 left-28 font-extrabold text-blue-700 z-40 lg:text-7xl text-3xl'>
            Fluffy Hugs
        </div>
        <div id="imgs">
            ...
            <div className="absolute bottom-5 left-12 flex z-30 gap-4">
                <FaTwitter key={1} className="cursor-pointer w-10 h-10 rounded-full text-white bg-blue-500 hover:scale-110 duration-300"/>
                <FaDiscord key={1} className="cursor-pointer w-10 h-10 rounded-full text-white bg-blue-500 p-1 hover:scale-110 duration-300"/>
                <SiOpensea key={3} className="cursor-pointer w-10 h-10 rounded-full text-white bg-blue-500 hover:scale-110 duration-300" />
            </div>
        </div>
